...
public class ViewerCameraEuler extends draw3D.camera.setup.IViewerCameraEuler implements Camera
{
	public ViewerCameraEuler(){ super(); }
	public ViewerCameraEuler(Viewable viewer){ super(viewer); }
