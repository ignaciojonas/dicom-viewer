...
public class ViewerCamera extends draw3D.camera.setup.IViewerCamera implements Camera
{
	public ViewerCamera(){ super(); }
	public ViewerCamera(Viewable viewer){ super(viewer); }
