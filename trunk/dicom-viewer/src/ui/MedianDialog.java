...
*/
public class MedianDialog extends javax.swing.JDialog {
	...
	public MedianDialog(JFrame frame, JTabbedPane tabbedPane1, HandImage handImageFiltered) {
		super(frame);
		this.setTitle("Median Set");
...
//			ImagesData.cloneImagesBToImagesFiltered();
		MedianFilter mF = new MedianFilter(this.handImageFiltered,((Integer) jSpinner1.getValue()).intValue(), ImagesData.imagesB);
		mF.start();
